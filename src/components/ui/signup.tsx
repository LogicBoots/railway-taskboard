      ...
      >
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h1 className="text-2xl md:text-3xl font-bold mb-1">Create an account</h1>
            <p className="text-gray-400 mb-8">Welcome! Create an account to get started.</p>
